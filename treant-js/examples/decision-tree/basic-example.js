var config = {
    ...
    node2 = { parent: node1, text: { gini: "gini: 0.766", samples: "samples: 40", attribute: "attribute: fins <= 0.5", class_name: "class_name: Fish", value: "value: [4, 0, 8, 13, 10, 0, 5]" }, connectors: { type: "curve", style: { "stroke-width": 8.0 } }, image: "plots/gini2.png" },
